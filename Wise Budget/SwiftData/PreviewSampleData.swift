...
struct PreviewSampleData {
    static var container: ModelContainer {
        ...
        let expenses: [Expense] = [
            Expense(amount: 52.30, currency: "USD", date: date(year: 2026, month: 3, day: 17), category: groceries),
            Expense(amount: 15.00, currency: "USD", date: date(year: 2026, month: 3, day: 16), category: transport),
        ...
        // Incomes
        let incomes: [Income] = [
            Income(amount: 4500.00, currency: "USD", date: date(year: 2026, month: 3, day: 1), category: salary),
            Income(amount: 800.00, currency: "EUR", date: date(year: 2026, month: 3, day: 10), category: freelance),
